...
//    private static final float STOKE_WIDTH = 5f;
    ...
    //默认开始动画
    private boolean mDefaultStartAnim;
    ...
    private void loadAttrs(Context context, AttributeSet attrs) {
        ...
        if (attrs != null) {
            ...
            mDefaultStartAnim = typedArray.getBoolean(R.styleable.WhorlView_Style_WhorlView_DefaultStartAnim,true);
            typedArray.recycle();
        } else {
