...
import com.sunwayworld.common.base.BaseFragment;
...
public abstract class BaseListFragment<V, P extends BasePresenter<V>> extends BaseFragment<V, P> {
    /**
     * 根布局
     */
    ...
    private void initAdapter() {
        ...
        mRecyclerView.addItemDecoration(new MyDecoration(context, MyDecoration.VERTICAL_LIST));
